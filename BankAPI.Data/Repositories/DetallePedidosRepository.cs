...
public class DetallePedidosRepository : IDetallePedidosRepository
{
    ...
    {
        var db = dbConnection();
        var sql = @"INSERT INTO DetallePedidos (ID_Pedido , ID_Producto , Cantidad , Subtotal, FechaCreacion , FechaModificacion) VALUES (@ID_Pedido , @ID_Producto , @Cantidad , @Subtotal , @FechaModificacion, @FechaModificacion)";
